...
from isaaclab.humanoid_tasks.learning.modules import ActorCritic
...
class PPO:
    ...
    def update(self):
        ...
        for (
            ...
            loss = surrogate_loss + self.value_loss_coef * value_loss - self.entropy_coef * entropy_batch.mean() + 0.1 * bound_loss
