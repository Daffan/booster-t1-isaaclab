...
import isaaclab.humanoid_tasks.learning as locomotion
from isaaclab.humanoid_tasks.learning.algorithms import PPO, ROAPPO
from isaaclab.humanoid_tasks.learning.env import VecEnv
from isaaclab.humanoid_tasks.learning.modules import (
    ActorCritic,
    ActorCriticHistory,
    ActorCriticRecurrent,
    EmpiricalNormalization,
)
from isaaclab.humanoid_tasks.learning.utils import store_code_state
...
class OnPolicyRunner:
    ...
    def __init__(self, env: RslRlVecEnvWrapper, train_cfg, log_dir=None, device="cpu"):
        ...
        self.alg: ROAPPO = alg_class(actor_critic, device=self.device, **self.alg_cfg)
    ...
    def learn(self, num_learning_iterations: int, init_at_random_ep_len: bool = False):
        ...
        if self.log_dir is not None and self.writer is None:
            ...
            if self.logger_type == "neptune":
                from isaaclab.humanoid_tasks.learning.utils.neptune_utils import NeptuneSummaryWriter

                self.writer = NeptuneSummaryWriter(log_dir=self.log_dir, flush_secs=10, cfg=self.cfg)
                self.writer.log_config(self.env.cfg, self.cfg, self.alg_cfg, self.policy_cfg)
            elif self.logger_type == "wandb":
                from isaaclab.humanoid_tasks.learning.utils.wandb_utils import WandbSummaryWriter
    ...
    def log(self, locs: dict, width: int = 80, pad: int = 35):
        ...
        mean_std = self.alg.actor_critic.logstd.exp().mean()
